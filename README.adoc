...
Se recomienda https://github.com/facebook/create-react-app[Create React App] (https://github.com/tuchk4/awesome-create-react-app) para iniciar los proyectos. Una alternativa es https://github.com/NYTimes/kyt[Kyt].
