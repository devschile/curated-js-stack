...
https://pouchdb.com/[PouchDB] para sincronizar datos cliente - servidor. Si prefieres _SQL_ puedes usar http://alasql.org/[AlaSQL].
...
https://momentjs.com/[Moment.js] para manejo de fechas. Unas alternativas https://github.com/you-dont-need/You-Dont-Need-Momentjs[en este repo]. Alternativa https://github.com/iamkun/dayjs[DayJS] o https://github.com/you-dont-need/You-Dont-Need-Momentjs[You don´t need Momentjs].
