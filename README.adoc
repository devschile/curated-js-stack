...
Para trabajar con funciones https://aws.amazon.com/es/lambda/[AWS Lambda]. Una alternativa es https://claudiajs.com/claudia.html[Claudia.js]. Si no se desea utilizar _Amazon_
...
Complementar con https://github.com/zanata/zanata-platform[Zanata] o https://crowdin.com/[Crowdin].
...
### Documentación: https://docs.antora.org/[Antora Docs]
